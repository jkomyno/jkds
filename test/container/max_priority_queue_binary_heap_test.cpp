...
namespace {
  ...
  class MaxPQBinaryHeapTest : public ::testing::Test {
  protected:
  };
...
TEST_F(MaxPQBinaryHeapTest, full_pod) {
  // Associate (5 -> 'm'), (4, 'i'), (1, 'n'), (3, 'h'), (6, 'e'), (0, 'a'), (2, 'p')
  vector<uint8_t> keys{5, 4, 1, 3, 6, 0, 2};
